...
- `is_user == True` for any of its rows, OR
- All of the following are true (a real-player gate):
...
Tracks failing the gate are not present in `poses.parquet` at all (not
